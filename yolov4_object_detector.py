...
Original file is located at
    https://colab.research.google.com/drive/19tRhFPCen7WCJKt8olqgutsRga5JwdED

# Yolo v4 - The Fastest and most Accurate Object Detector
Hello everyone, my name is Aris. This is my code to make Object Detector using Yolo v4, which is the fastest and most accurate object detector ever currently now. This simulation also involve Webcam that can detect with your own camera. wanna know more about this Yolo, check this link <br> 
<a href='https://github.com/AlexeyAB/darknet'>Darknet Yolo</a><br>
![picture](https://cdn-images-1.medium.com/max/1098/1*i-QSgEXjpi2VQngAIkbn1w.png)
"""
...
I will be using the famous AlexeyAB's darknet repository in this tutorial to perform YOLOv4 detections.
"""
...
"""## Darknet for Python
In order to utilize YOLOv4 with Python code we will use some of pre-built functions in darknet.py by importing the functions into our workstation. Feel free to checkout the darknet.py file to see the function codes in detail! 
"""
...
Let's make sure our model has successfully been loaded and that we can make detections properly on a test image. You can try with your own, with upload your image to this google colab. and then make a little change with its path. Let's enjoy it !
"""
...
"""## Helper Functions
Here are a few helper functions defined that will be used to convinient convert between different image types within our later steps.
"""
...
<a href='https://drive.google.com/file/d/1fUHKYsAUeDOUC3AECZJRF55OxjuZQ5Dx/view?usp=sharing'>Yolo Webcam Workflow</a>
"""
